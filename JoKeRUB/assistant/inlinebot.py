...
def main_menu():
    text = f"**- [سـورس فلسطين العرب](https://t.me/E9N99)\
        \n المسـاعد\
        \n\
        \n◽ سورس فلسطين لـ {mention}**"
    buttons = [
        ...
        if query.startswith("l313l"):
            buttons = [
                (
                    ...
                    Button.url(" 𝖯𝖠𝖫𝖤𝖲𝖳𝖨𝖭𝖤 UsᴇʀBoᴛ", "https://t.me/E9N99"),
                )
            ]
